...
> **Active**: 1 | **Pending**: 8 | **Completed This Week**: 2
...
|----|------|----------|--------|-------|------------|--------|
| UPSYNC-001 | Upsync SSOT baseline lock + gap evidence refresh | P1 | Completed |  | 2026-02-10 | `docs/project/tasks/UPSYNC-001.md` |
...
| UPSYNC-003 | Unified error-policy parity for Gemini/Antigravity loops | P0 | Active |  | 2026-02-10 | `docs/project/tasks/UPSYNC-003.md` |
