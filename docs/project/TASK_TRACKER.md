...
> **Active**: 1 | **Pending**: 7 | **Completed This Week**: 3
...
| UPSYNC-004 | Model-level rate-limit clear/reset parity (backend + UI) | P1 | Active |  | 2026-02-10 | `docs/project/tasks/UPSYNC-004.md` |
