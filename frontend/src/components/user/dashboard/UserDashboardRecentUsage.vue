  ...
  <div class="card">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        <div v-for="log in data" :key="log.id" class="glass flex items-center justify-between rounded-xl p-4 transition-colors hover:bg-white/80 dark:hover:bg-dark-950/45">
