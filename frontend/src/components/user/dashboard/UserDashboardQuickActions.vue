  ...
  <div class="card">
    ...
    <div class="space-y-3 p-4">
      <button
        ...
        class="glass group flex w-full items-center gap-4 rounded-xl p-4 text-left transition-all duration-200 hover:border-primary-200/60 hover:bg-white/80 hover:shadow-glass-sm dark:hover:border-primary-500/25 dark:hover:bg-dark-950/45"
      >
