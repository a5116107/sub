<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <!-- Balance -->
    <div v-if="!isSimple" class="stat-card p-4 items-center card-hover">
    ...
    <div class="stat-card p-4 items-center card-hover">
      ...
      <div>
        ...
        <p class="text-xs">
          ...
          <span class="text-gold-700 dark:text-gold-300" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
