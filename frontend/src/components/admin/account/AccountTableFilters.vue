...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'gemini', label: 'Gemini' }, { value: 'qwen', label: 'Qwen' }, { value: 'iflow', label: 'iFlow' }, { value: 'antigravity', label: 'Antigravity' }])
